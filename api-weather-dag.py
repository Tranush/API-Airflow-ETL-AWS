...
def transform_load_data(task_instance):
    ...
    df_data.to_csv(f"s3://af-project/{dt_string}.csv", index=False, storage_options=aws_credentials)
...
with DAG('weather_dag',
        ...
        endpoint='/data/2.5/weather?q=Portland&APPID=fa8f2a4dc440b5af30921c81cac9a2fe'
        ) 
